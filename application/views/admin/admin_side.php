...
<div class="list-group">
    <?
    echo '<div class="list-group-item">'.anchor('admin/users',"Users").' <br/>'. anchor('admin/members#table','Members')."<br>".anchor('admin/members/attendance', 'Attendance').'<br>'.anchor('admin/members/registrations', 'Registrations').'<br>'.anchor('admin/forms', 'Forms').'<br>'.anchor('admin/store', 'Store')."</div>"; 
